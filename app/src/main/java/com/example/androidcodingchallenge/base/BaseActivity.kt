...
import com.example.map.utils.tryAction
...
open class BaseActivity: AppCompatActivity(), BaseFragment.FragmentNavigation, FragNavController.TransactionListener,
    ...
    override fun openDialogFragment(dialogFragment: DialogFragment) {
        basefragNavController.showDialogFragment(dialogFragment)
    }
